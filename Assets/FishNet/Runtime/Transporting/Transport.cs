...
namespace FishNet.Transporting
{
    ...
    public abstract class Transport : MonoBehaviour
    {
        ...
        /// </summary>
        [Obsolete(
            "This method is being replaced with Initialize(networkManager, transportIndex) to support multiple transports at once.")] //Remove on 2022/06/01 in favor of AllowStacking.
        ...
        {
            var canLog = NetworkManager == null
                ? NetworkManager.StaticCanLog(LoggingType.Warning)
                : NetworkManager.CanLog(LoggingType.Warning);
            if (canLog)
        ...
        /// <returns></returns>
        [Obsolete(
            "This method is being removed in a future version. Channel count will always be 2, for reliable and unreliable.")] //Remove on 2022/06/01.
        public virtual byte GetChannelCount()
        {
            return 2;
        }
        ...
        public virtual byte GetDefaultReliableChannel()
        {
            return 0;
        } //Remove on 2022/06/01.
        ...
        /// <returns>Channel as byte.</returns>
        [Obsolete("This method will be removed. Reliable will always be 0, and unreliable always 1.")]
        public virtual byte GetDefaultUnreliableChannel()
        {
            return 1;
        } //Remove on 2022/06/01.
