...
namespace FishNet.Transporting
{
    ...
    public struct ServerReceivedDataArgs
    {
        ...
        [Obsolete(
            "Use ServerReceivedDataArgs(data, channel, connectionid, transportIndex) instead.")] //Remove on 2022/06/01 in favor of AllowStacking.
    ...
    public struct ClientReceivedDataArgs
    {
        ...
        [Obsolete(
            "Use ClientReceivedDataArgs(data, channel, transportIndex) instead.")] //Remove on 2022/06/01 in favor of AllowStacking.
    ...
    public struct RemoteConnectionStateArgs
    {
        ...
        [Obsolete(
            "Use RemoteConnectionStateArgs(connectionState, connectionId, transportIndex) instead.")] //Remove on 2022/06/01 in favor of AllowStacking.
    ...
    public struct ServerConnectionStateArgs
    {
        ...
        [Obsolete(
            "Use ServerConnectionStateArgs(connectionState, transportIndex) instead.")] //Remove on 2022/06/01 in favor of AllowStacking.
    ...
    public struct ClientConnectionStateArgs
    {
        ...
        [Obsolete(
            "Use ClientConnectionStateArgs(transportIndex, connectionState) instead.")] //Remove on 2022/06/01 in favor of AllowStacking.
        public
            ClientConnectionStateArgs(
                LocalConnectionStates connectionState) //Remove on 2022/06/01 in favor of AllowStacking.
        {
            ConnectionState = connectionState;
            TransportIndex = 0;
        }
