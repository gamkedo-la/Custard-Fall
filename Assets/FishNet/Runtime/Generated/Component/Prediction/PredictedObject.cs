...
namespace FishNet.Component.Prediction
{
    ...
    public class PredictedObject : MonoBehaviour
    {
        ...
        /// </summary>
        [Tooltip("Duration to smooth desynchronizations over.")] [Range(0.01f, 0.5f)] [SerializeField]
        ...
        /// </summary>
        [Tooltip("Rigidbody to predict.")] [SerializeField]
        private Rigidbody _rigidbody;

        /// <summary>
        /// Rigidbody2D to predict.
        /// </summary>
        [Tooltip("Rigidbody2D to predict.")] [SerializeField]
        ...
        [SerializeField] [HideInInspector] private float _lastPredictionRatio;
        [SerializeField] [HideInInspector] private Transform _lastGraphicalObject;
        [SerializeField] [HideInInspector] private PredictionType _lastMovementType;
        [SerializeField] [HideInInspector] private float _lastSmoothingDuration;
        [SerializeField] [HideInInspector] private UnityEngine.Component _lastSelectedRigidbody;
        [SerializeField] [HideInInspector] private UnityEngine.Component _addedPredictedRigidbody;
        [SerializeField] [HideInInspector] private DesyncSmoother _addedDesyncSmoother;
        [SerializeField] [HideInInspector] private bool _rebuildComponents;
        ...
        private void InitializeOnce()
        {
                ...
                (_predictionType == PredictionType.Rigidbody && _rigidbody == null))
            {
                if (NetworkManager.StaticCanLog(LoggingType.Error))
                    Debug.LogError(
                        $"MovementType on {gameObject.name} uses a physics object but rigidbody or rigidbody2d is not set. Initialization will fail.");
                return;
            }
        }
        ...
        private void AddScripts()
        {
            ...
            var go = _graphicalObject.gameObject;
        ...
        private void OnValidate()
        {
            ...
            {
                Debug.LogError(
                    $"The graphical object may not be the root of the transform. Your graphical objects must be beneath your prediction scripts so that they may be smoothed independently during desynchronizations.");
            ...
            if (_predictionRatio != _lastPredictionRatio)
            {
                ...
                {
                    var prb = (PredictedRigidbodyBase) _addedPredictedRigidbody;
