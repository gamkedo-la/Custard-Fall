...
namespace FishNet.Managing.Scened
{
    ...
    public class UnloadQueueData
    {
        ...
        /// </summary>
        [System.NonSerialized] public readonly SceneScopeTypes ScopeType;

        /// <summary>
        /// Connections to unload scenes for. Only valid on the server and when ScopeType is Connections.
        /// </summary>
        [System.NonSerialized] public NetworkConnection[] Connections;
        ...
        internal UnloadQueueData(SceneScopeTypes scopeType, NetworkConnection[] conns, SceneUnloadData sceneUnloadData,
