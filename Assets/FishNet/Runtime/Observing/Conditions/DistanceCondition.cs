...
namespace FishNet.Component.Observing
{
    ...
    public class DistanceCondition : ObserverCondition
    {
        ...
        /// 
        /// </summary>
        [Tooltip("Maximum distance a client must be within this object to see it.")] [SerializeField]
        ...
        /// </summary>
        private Dictionary<NetworkConnection, float> _timedUpdates = new();
        ...
        public override bool ConditionMet(NetworkConnection connection, bool currentlyAdded, out bool notProcessed)
        {
            ...
            if (currentlyAdded)
            {
                var maxModified = MaximumDistance * (1f + _hideDistancePercent);
            ...
            var thisPosition = NetworkObject.transform.position;
        ...
        {
            var copy = CreateInstance<DistanceCondition>();
