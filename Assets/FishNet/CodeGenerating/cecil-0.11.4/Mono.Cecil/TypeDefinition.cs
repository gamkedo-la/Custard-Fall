    ...
    public sealed class TypeDefinition : TypeReference, IMemberDefinition, ISecurityDeclarationProvider
    {
        ...
        public Collection<TypeDefinition> NestedTypes
        {
            get
            {
                ...
                Interlocked.CompareExchange(ref nested_types, new MemberDefinitionCollection<TypeDefinition>(this),
                    null);
                return nested_types;
            }
        }
        ...
        public Collection<PropertyDefinition> Properties
        {
            get
            {
                ...
                Interlocked.CompareExchange(ref properties, new MemberDefinitionCollection<PropertyDefinition>(this),
                    null);
                return properties;
            }
        }
        ...
        {
            get =>
                attributes.GetMaskedAttributes((uint) TypeAttributes.VisibilityMask, (uint) TypeAttributes.NotPublic);
        ...
        {
            get => attributes.GetMaskedAttributes((uint) TypeAttributes.LayoutMask,
        ...
        {
            get => attributes.GetMaskedAttributes((uint) TypeAttributes.ClassSemanticMask,
        ...
        {
            get => attributes.GetAttributes((uint) TypeAttributes.WindowsRuntime);
            set => attributes = attributes.SetAttributes((uint) TypeAttributes.WindowsRuntime, value);
        }

        public bool IsAnsiClass
        {
            get => attributes.GetMaskedAttributes((uint) TypeAttributes.StringFormatMask,
        ...
        {
            get => (TypeDefinitionProjection) projection;
