...
namespace MonoFN.Cecil
{
    ...
    internal sealed class MetadataSystem
    {
        ...
        public void Clear()
        {
            if (NestedTypes != null) NestedTypes = new Dictionary<uint, Collection<uint>>(0);
            if (ReverseNestedTypes != null) ReverseNestedTypes = new Dictionary<uint, uint>(0);
            if (Interfaces != null) Interfaces = new Dictionary<uint, Collection<Row<uint, MetadataToken>>>(0);
            if (ClassLayouts != null) ClassLayouts = new Dictionary<uint, Row<ushort, uint>>(0);
            if (FieldLayouts != null) FieldLayouts = new Dictionary<uint, uint>(0);
            if (FieldRVAs != null) FieldRVAs = new Dictionary<uint, uint>(0);
            if (FieldMarshals != null) FieldMarshals = new Dictionary<MetadataToken, uint>(0);
            if (Constants != null) Constants = new Dictionary<MetadataToken, Row<ElementType, uint>>(0);
            if (Overrides != null) Overrides = new Dictionary<uint, Collection<MetadataToken>>(0);
            if (CustomAttributes != null) CustomAttributes = new Dictionary<MetadataToken, Range[]>(0);
            if (SecurityDeclarations != null) SecurityDeclarations = new Dictionary<MetadataToken, Range[]>(0);
            if (Events != null) Events = new Dictionary<uint, Range>(0);
            if (Properties != null) Properties = new Dictionary<uint, Range>(0);
            if (Semantics != null) Semantics = new Dictionary<uint, Row<MethodSemanticsAttributes, MetadataToken>>(0);
            if (PInvokes != null) PInvokes = new Dictionary<uint, Row<PInvokeAttributes, uint, uint>>(0);
            if (GenericParameters != null) GenericParameters = new Dictionary<MetadataToken, Range[]>(0);
            ...
            if (StateMachineMethods != null) StateMachineMethods = new Dictionary<uint, uint>(0);
        }
        ...
        public bool TryGetGenericConstraintMapping(GenericParameter generic_parameter,
        ...
        public bool TryGetLocalScopes(MethodDefinition method,
