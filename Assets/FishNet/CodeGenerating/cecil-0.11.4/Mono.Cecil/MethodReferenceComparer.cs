...
namespace MonoFN.Cecil
{
    internal sealed class MethodReferenceComparer : EqualityComparer<MethodReference>
    {
        ...
        [ThreadStatic] private static List<MethodReference> xComparisonStack = null;

        [ThreadStatic] private static List<MethodReference> yComparisonStack = null;
        ...
        public static bool AreEqual(MethodReference x, MethodReference y)
        {
            ...
            if (xGeneric != null || yGeneric != null)
            {
                ...
                for (var i = 0; i < xGeneric.GenericArguments.Count; i++)
                    if (!TypeReferenceEqualityComparer.AreEqual(xGeneric.GenericArguments[i],
                            yGeneric.GenericArguments[i]))
                        return false;
            }
            ...
            if (xResolved == null)
            {
                ...
                for (var i = 0; i < xComparisonStack.Count; i++)
