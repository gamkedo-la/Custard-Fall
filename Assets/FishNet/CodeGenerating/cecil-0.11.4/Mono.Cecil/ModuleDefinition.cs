...
namespace MonoFN.Cecil
{
    ...
    public sealed class ModuleDefinition : ModuleReference, ICustomAttributeProvider, ICustomDebugInformationProvider,
        IDisposable
    {
        ...
        [Obsolete("Use FileName")] public string FullyQualifiedName => file_name;
        ...
        public bool HasResources
        {
            get
            {
                ...
                if (HasImage)
                    return Image.HasTable(Table.ManifestResource) ||
                           Read(this, (_, reader) => reader.HasFileResource());
        ...
        public Collection<CustomAttribute> CustomAttributes =>
            custom_attributes ?? this.GetCustomAttributes(ref custom_attributes, this);
        ...
        {
            return runtimeName
                ? TypeParser.ParseType(this, fullName, true)
                : GetType(fullName);
        }
        ...
        private readonly object module_lock = new();
        ...
        {
            var stream = GetFileStream(fileName, FileMode.Open,
                parameters.ReadWrite ? FileAccess.ReadWrite : FileAccess.Read, FileShare.Read);
        ...
        private static ModuleDefinition ReadModule(Disposable<Stream> stream, string fileName,
