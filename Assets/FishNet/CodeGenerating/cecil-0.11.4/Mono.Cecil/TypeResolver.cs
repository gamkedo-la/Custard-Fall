...
namespace MonoFN.Cecil
{
    internal sealed class TypeResolver
    {
        ...
        {
            return typeReference.IsGenericInstance
                ? new TypeResolver((GenericInstanceType) typeReference)
                : new TypeResolver();
        }
        ...
        public MethodReference Resolve(MethodReference method)
        {
            ...
            if (genericInstanceMethod != null)
            {
                ...
                foreach (var ga in genericInstanceMethod.GenericArguments) m.GenericArguments.Add(Resolve(ga));
        ...
        public TypeReference Resolve(TypeReference typeReference, bool includeTypeDefinitions)
        {
            ...
            if (genericParameter != null)
            {
                if (_typeDefinitionContext != null &&
                    _typeDefinitionContext.GenericArguments.Contains(genericParameter))
        ...
        private TypeReference HandleOwnerlessInvalidILCode(GenericParameter genericParameter)
        {
            ...
            if (genericParameter.Type == GenericParameterType.Method && _typeDefinitionContext != null &&
                genericParameter.Position < _typeDefinitionContext.GenericArguments.Count)
