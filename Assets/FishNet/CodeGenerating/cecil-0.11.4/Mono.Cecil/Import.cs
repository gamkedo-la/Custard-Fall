...
namespace MonoFN.Cecil
{
    ...
    internal struct ImportGenericContext
    {
        ...
        {
            return context != null ? new ImportGenericContext(context) : default;
        }
    }
    ...
    public class DefaultReflectionImporter : IReflectionImporter
    {
        ...
        private static TypeReference ImportGenericParameter(Type type, ImportGenericContext context)
        {
            ...
            if (type.DeclaringMethod != null)
                return context.MethodParameter(NormalizeMethodName(type.DeclaringMethod),
        ...
        private MethodReference ImportMethod(SR.MethodBase method, ImportGenericContext context,
            ImportGenericKind import_kind)
        {
            ...
            try
            {
                ...
                reference.ReturnType = method_info != null
                    ...
                    : ImportType(typeof(void), default);
    ...
    public class DefaultMetadataImporter : IMetadataImporter
    {
        ...
        private TypeReference ImportTypeSpecification(TypeReference type, ImportGenericContext context)
        {
            switch (type.etype)
            {
                ...
                case ElementType.FnPtr:
                    ...
                    for (var i = 0; i < fnptr.Parameters.Count; i++)
                ...
                case ElementType.MVar:
                    ...
                    if (mvar_parameter.DeclaringMethod == null)
                        throw new InvalidOperationException();
                    return context.MethodParameter(context.NormalizeMethodName(mvar_parameter.DeclaringMethod),
                        mvar_parameter.Position);
            }
        ...
        private MethodReference ImportMethod(MethodReference method, ImportGenericContext context)
        {
            ...
            try
            {
                ...
                var reference_parameters =
                    reference.parameters = new ParameterDefinitionCollection(reference, parameters.Count);
                for (var i = 0; i < parameters.Count; i++)
                    reference_parameters.Add(
                        new ParameterDefinition(ImportType(parameters[i].ParameterType, context)));
    ...
    internal static partial class Mixin
    {
        ...
        public static bool TryGetAssemblyNameReference(this ModuleDefinition module,
            AssemblyNameReference name_reference, out AssemblyNameReference assembly_reference)
        {
            var references = module.AssemblyReferences;
