...
namespace MonoFN.Cecil
{
    public abstract class TypeSystem
    {
        ...
        [Obsolete("Use CoreLibrary")] public IMetadataScope Corlib => CoreLibrary;
        ...
        public TypeReference Boolean =>
            type_bool ?? LookupSystemValueType(ref type_bool, "Boolean", ElementType.Boolean);
        ...
        public TypeReference UIntPtr =>
            type_uintptr ?? LookupSystemValueType(ref type_uintptr, "UIntPtr", ElementType.U);

        public TypeReference String => type_string ?? LookupSystemType(ref type_string, "String", ElementType.String);

        public TypeReference TypedReference => type_typedref ??
                                               LookupSystemValueType(ref type_typedref, "TypedReference",
    ...
    internal static partial class Mixin
    {
        ...
        public static bool IsCoreLibrary(this ModuleDefinition module)
        {
            ...
            if (module.HasImage &&
                module.Read(module, (m, reader) => reader.image.GetTableLength(Table.AssemblyRef) > 0))
                return false;
