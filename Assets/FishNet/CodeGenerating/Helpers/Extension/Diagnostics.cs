...
namespace FishNet.CodeGenerating.Helping
{
    internal static class Diagnostics
    {
        ...
        internal static void AddError(this List<DiagnosticMessage> diagnostics, MethodDefinition methodDef,
            string message)
        {
            diagnostics.AddMessage(DiagnosticType.Error, methodDef.DebugInformation.SequencePoints.FirstOrDefault(),
                message);
        }

        internal static void AddMessage(this List<DiagnosticMessage> diagnostics, DiagnosticType diagnosticType,
            SequencePoint sequencePoint, string message)
        {
